<?php
/**
 * Approve Art Entry API Endpoint
 *
 * Approves a pending art entry via POST method.
...
try {
    ...
    // Approve art entry
    $result = approveArtEntry($pdo, $entryId);
    ...
    error_log("Approve Entry API Error: " . $e->getMessage());
    http_response_code(500);
    echo json_encode([
        'success' => false,
        'message' => 'An error occurred while approving the entry.'
    ]);
}
